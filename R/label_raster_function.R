label_raster <- function(data) {
  ...
  mutate(group = recode(label,
                        ...
                        "Wetlands (inland) - Seasonal/intermittent saline brackish or alkaline lakes and flats" = "Wetlands - seasonal",
                        "Wetlands - seasonal" = "Wetlands - seasonal",
                        "Wetlands (inland) - Seasonal/intermittent freshwater lakes (over 8 ha)" = "Wetlands - seasonal",
